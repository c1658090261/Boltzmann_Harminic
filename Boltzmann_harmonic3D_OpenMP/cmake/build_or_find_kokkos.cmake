...
# set default backend
set(KOKKOS_LBM_BACKEND "Undefined" CACHE STRING
  "Kokkos default backend device")

# Set the possible values for kokkos backend device
set_property(CACHE KOKKOS_LBM_BACKEND PROPERTY STRINGS
...
if(KOKKOS_LBM_BACKEND MATCHES "Cuda")
...
elseif(KOKKOS_LBM_BACKEND MATCHES "HIP")
  if((NOT DEFINED Kokkos_ENABLE_HWLOC) OR(NOT Kokkos_ENABLE_HWLOC))
    set(Kokkos_ENABLE_HWLOC ON CACHE BOOL "")
  endif()
...
elseif(KOKKOS_LBM_BACKEND MATCHES "OpenMP")
  if((NOT DEFINED Kokkos_ENABLE_HWLOC) OR(NOT Kokkos_ENABLE_HWLOC))
    set(Kokkos_ENABLE_HWLOC ON CACHE BOOL "")
  endif()
...
elseif(KOKKOS_LBM_BACKEND MATCHES "Undefined")
  message(FATAL_ERROR "[euler / kokkos] You must chose a valid KOKKOS_LBM_BACKEND !")
endif()
...
if(KOKKOS_PROJ_TMPL_USE_GIT)
  FetchContent_Declare(kokkos_external
    GIT_REPOSITORY https://gitee.com/laohuxin/kokkos.git
    GIT_TAG 4.2.01
    GIT_PROGRESS TRUE
  )
else()
...
if(TARGET Kokkos::kokkos)
  ...
  set(KOKKOS_PROJ_TMPL_FOUND True)
  set(HAVE_KOKKOS 1)
else()
